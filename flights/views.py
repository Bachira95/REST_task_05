...
from .serializers import FlightSerializer,UpdateBookingSerializer,UpdateUserBookingSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer
